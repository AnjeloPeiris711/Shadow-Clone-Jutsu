...
| AA  | Authoritative Answer - this bit is valid in responses, and specifies that the responding name server is an authority for the domain name in the question section. The contents of the answer section may have multiple owner names because of aliases. The AA bit <br><br> **Note:** The contents of the answer section may have multiple owner names because of aliases. The AA bit is not working as expected in some scenarios. |
